...
plot_history.plot_mse_history("train_history_unet_pom_mae_10lvels.pkl", "mse_pom_mae")
plot_history.plot_mae_history("train_history_unet_pom_mae_10lvels.pkl", "mae_pom_mae")
plot_history.plot_pod_history("train_history_unet_pom_mae_10lvels.pkl", "pod_pom_mae")
plot_history.plot_far_history("train_history_unet_pom_mae_10lvels.pkl", "far_pom_mae")

plot_history.plot_mse_history("train_history_unet_pom_mse_10lvels.pkl", "mse_pom_mse")
plot_history.plot_mae_history("train_history_unet_pom_mse_10lvels.pkl", "mae_pom_mse")
plot_history.plot_pod_history("train_history_unet_pom_mse_10lvels.pkl", "pod_pom_mse")
plot_history.plot_far_history("train_history_unet_pom_mse_10lvels.pkl", "far_pom_mse")
exit()
