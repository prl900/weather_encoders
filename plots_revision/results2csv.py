...
get_stats('../unet_comb3_mse_40_10levels.h5', 4, .0, x_test, y_test)
get_stats('../unet_comb3_mse_80_10levels.h5', 8, .0, x_test, y_test)
...
get_stats('../unet_comb3_mse_04_10levels.h5', .0, 4, x_test, y_test)
get_stats('../unet_comb3_mse_08_10levels.h5', .0, 8, x_test, y_test)
...
get_stats('../unet_comb3_mse_44_10levels.h5', 4, 4, x_test, y_test)
get_stats('../unet_comb3_mse_88_10levels.h5', 8, 8, x_test, y_test)

print("MSE 5:")
get_stats('../unet_comb3_mse_b5_00_10levelsb2.h5', .0, .0, x_test, y_test)

get_stats('../unet_comb3_mse_b5_50_10levelsb2.h5', 5, .0, x_test, y_test)
get_stats('../unet_comb3_mse_b5_10_10levelsb2.h5', 1, .0, x_test, y_test)
get_stats('../unet_comb3_mse_b5_20_10levelsb2.h5', 2, .0, x_test, y_test)
get_stats('../unet_comb3_mse_b5_40_10levelsb2.h5', 4, .0, x_test, y_test)
get_stats('../unet_comb3_mse_b5_80_10levelsb2.h5', 8, .0, x_test, y_test)

get_stats('../unet_comb3_mse_b5_05_10levelsb2.h5', .0, 5, x_test, y_test)
get_stats('../unet_comb3_mse_b5_01_10levelsb2.h5', .0, 1, x_test, y_test)
get_stats('../unet_comb3_mse_b5_02_10levelsb2.h5', .0, 2, x_test, y_test)
get_stats('../unet_comb3_mse_b5_04_10levelsb2.h5', .0, 4, x_test, y_test)
get_stats('../unet_comb3_mse_b5_08_10levelsb2.h5', .0, 8, x_test, y_test)

get_stats('../unet_comb3_mse_b5_55_10levelsb2.h5', 5, 5, x_test, y_test)
get_stats('../unet_comb3_mse_b5_11_10levelsb2.h5', 1, 1, x_test, y_test)
get_stats('../unet_comb3_mse_b5_22_10levelsb2.h5', 2, 2, x_test, y_test)
get_stats('../unet_comb3_mse_b5_44_10levelsb2.h5', 4, 4, x_test, y_test)
get_stats('../unet_comb3_mse_b5_88_10levelsb2.h5', 8, 8, x_test, y_test)

print("MSE 2:")
get_stats('../unet_comb3_mse_b2_00_10levelsb2.h5', .0, .0, x_test, y_test)

get_stats('../unet_comb3_mse_b2_50_10levelsb2.h5', 5, .0, x_test, y_test)
get_stats('../unet_comb3_mse_b2_10_10levelsb2.h5', 1, .0, x_test, y_test)
get_stats('../unet_comb3_mse_b2_20_10levelsb2.h5', 2, .0, x_test, y_test)
get_stats('../unet_comb3_mse_b2_40_10levelsb2.h5', 4, .0, x_test, y_test)
get_stats('../unet_comb3_mse_b2_80_10levelsb2.h5', 8, .0, x_test, y_test)

get_stats('../unet_comb3_mse_b2_05_10levelsb2.h5', .0, 5, x_test, y_test)
get_stats('../unet_comb3_mse_b2_01_10levelsb2.h5', .0, 1, x_test, y_test)
get_stats('../unet_comb3_mse_b2_02_10levelsb2.h5', .0, 2, x_test, y_test)
get_stats('../unet_comb3_mse_b2_04_10levelsb2.h5', .0, 4, x_test, y_test)
get_stats('../unet_comb3_mse_b2_08_10levelsb2.h5', .0, 8, x_test, y_test)

get_stats('../unet_comb3_mse_b2_55_10levelsb2.h5', 5, 5, x_test, y_test)
get_stats('../unet_comb3_mse_b2_11_10levelsb2.h5', 1, 1, x_test, y_test)
get_stats('../unet_comb3_mse_b2_22_10levelsb2.h5', 2, 2, x_test, y_test)
get_stats('../unet_comb3_mse_b2_44_10levelsb2.h5', 4, 4, x_test, y_test)
get_stats('../unet_comb3_mse_b2_88_10levelsb2.h5', 8, 8, x_test, y_test)
